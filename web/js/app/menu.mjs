        ...
        <div class="offcanvas offcanvas-bottom menu" tabindex="-1" id=${id} style="--bs-offcanvas-height: 40vh;" data-bs-theme="dark">
            ...
            <div class="offcanvas-body p-0">
                <div class="list-group rounded-0">
                    <a href="#" class="list-group-item list-group-item-action ${currentCarouselIndex == 0 ? 'active':''}" data-bs-target="#${carouselId}" data-bs-slide-to="0">
                    ...
                    <a href="#" class="list-group-item list-group-item-action ${currentCarouselIndex == 1 ? 'active':''}" data-bs-target="#${carouselId}" data-bs-slide-to="1">
