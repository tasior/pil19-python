...
export function Blinds({ active, socket, blinds, refreshBlinds }) {
    ...
    const onShowModal = (action, blind) => {
      setAction(action);
      setBlind(blind);
      setError(null);
      modal.show();
    ...
    const onSubmit = async e => {
      try {
        if (action == 'add' && (blind.channel == '' || blind.name == '')) {
                ...
                ${blinds.map(blind => html`
                  <div class="row gy-2 p-0 m-0">
                    ...
                    <div class="col col-6 bg-secondary-subtle py-2 text-end">
                      ...
                      <button class="btn p-2" onClick=${_ => onShowModal('edit', blind)}>
                      ...
                      <button class="btn p-2 text-danger" onClick=${_ => onShowModal('remove', blind)}>
              ...
              <div class="col col-12 py-0 text-start">
                <div class="row gy-2 p-0 m-0">
                  <div class="col col-12" style="--bs-bg-opacity: .5;">
                    <button class="btn p-2" onClick=${_ => onShowModal('add', { channel: '', name: '' })}>
